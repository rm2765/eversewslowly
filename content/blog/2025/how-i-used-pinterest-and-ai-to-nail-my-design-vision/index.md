---
title: Using Pinterest and AI to Nail My Design Vision
description: Discover how I used Pinterest and text-to-image AI tools to turn visual inspiration into fashion design sketches.
date: 2025-07-27T17:02:02.135Z
draft: false
tags:
  - Design Vision
  - Moodboard
...
items:
  - name: null
    content: <em>full body length view, women's fashion pose arms overhead holding bucket hat/helmet in an large coat with reflective trimming, highly detailed </em>
    image: txt_ex1.png
  - name: null
    content: <em>women's high waisted loose pants waist band with utility Velcro loops as embellishments </em>
    image: txt_ex2.png
keywords:
...
## Pinterest: A Visual Search Engine
 {{< figure src="pinterest.png" alt="Pinterest Login Landing" caption="Pinterest Login Landing Page" class="image fit" >}} 
...
👉 **Stat to Know:** Nearly, **70% of Pinterest users are women**, making it highly aligned with fashion’s core demographics. (Source: [Statista 2025](https://www.statista.com/statistics/248168/gender-distribution-of-pinterest-users/))
...
* 🗃️**Visual organization**: Project-specific boards keep inspiration organized and accessible

---

## Enter Text-to-Image Generative AI: Your Creative Collaborator
 {{< figure src="MS_txt.png" alt="Microsoft Designer's Text-to-Image Generator Tool" caption="Microsoft Designer's Text-to-Image Generator Tool" class="image fit" >}} 
...
As a student at the [BKLYN Fashion Academy](https://www.bklynlibrary.org/bklyn-fashion-academy) in 2024, I used Pinterest and Microsoft Designer’s text-to-image AI generator to develop a cohesive design vision for my Emergency Services-inspired collection. The AI images became my primary references when developing my final design sketches.
...
For my [BKYLN Fashion Academy](https://eversewslowly.com/blog/2025/behind-the-seams/) project, the theme was "**Women of Future Industries**," with a focus on **Emergency Services (EMS/FDNY).** This presented an interesting challenge: how do you take the functional, protective nature of emergency services uniforms into contemporary fashion that still honors the original purpose and aesthetic?

### **Step 1:** Building A Pinterest “Mood” Board
I started by [creating a new Pinterest board](https://www.pinterest.com/EverSewSlowly/women-in-future-jobs-fashion-design-realization/) specifically for my mini collection. My search strategy involved multiple keyword combinations to cast a wide net for inspiration:
...
1. **Access the Tool**: Go to [Microsoft Designer](https://designer.microsoft.com/) on your browser or via the app and select [Image Creator.](https://designer.microsoft.com/image-creator?scenario=texttoimage)
2. **Craft Your Prompt**: Write a detailed description of your envisioned garment or look.  
   One of the neat things about Microsoft Designer is that it showcases several examples of generated images and the prompts that created them. If you are new to these tools, I recommend reading through a couple and trying some of them out to get a feel for how it works.    

   👉**Tip**: You can use [ChatGPT](https://chatgpt.com), [ClaudeAI](https://claude.ai/) or others like it and ask it to improve or develop your text prompt if wordsmithing isn’t your forte.  

3. **Generate Multiple Variations at Once**: Once you have your prompt ready, select ‘Create’ and Microsoft Designer will return several (\~3-4) variations per prompt. *Note you get 15 free credits a month.
4. **Refine and Iterate**: Use the generated images as starting points for more specific follow-up prompts.
...
<section><header><h3>Look 1: Turnout Jacket Dress</h3></header>
<div class="content">
<p><a href="https://www.pinterest.com/pin/950892908816154736/" data-pin-do="embedPin"></a>
<a href="https://www.pinterest.com/pin/950892908815937935/" data-pin-do="embedPin"></a>
<a href="https://www.pinterest.com/pin/950892908816283863/" data-pin-do="embedPin"></a></p>
</div></section>

<section><header><h3>Look 2: Exo-Performance Suit</h3></header>
<div class="content"> 
<p><a href="https://www.pinterest.com/pin/950892908815813339/" data-pin-do="embedPin"></a>
<a href="https://www.pinterest.com/pin/950892908816165486/" data-pin-do="embedPin"></a></p>
</div></section>

<section><header><h3>Look 3: Bomber Jacket & Joggers </h3></header>
<div class="content">
<p><a href="https://www.pinterest.com/pin/950892908818021334/" data-pin-do="embedPin"></a>
<a href="https://www.pinterest.com/pin/950892908818593779/" data-pin-do="embedPin"></a>
<a href="https://www.pinterest.com/pin/950892908835397220/" data-pin-do="embedPin" height="336" width="236" frameborder="0"></a></p>
</div></section>
</div>

[Checkout the entire board!](https://www.pinterest.com/EverSewSlowly/women-in-future-jobs-fashion-design-realization/)
...
👉**Tip**: Try [Adobe Firefly](https://www.adobe.com/products/firefly/features/text-to-image.html) using the same prompt and see how the generated images differ and choose the platform that gives you the better results or tweak your prompt.

### Key Elements for Good AI Prompts:
<ul class="alt">
<li><b>Subject:</b>  women’s, men’s, unisex</li>
<li><b>Style/Vibe:</b>  photorealistic, high detail, futuristic, minimalist, romantic, etc.</li>
<li><b>Presentation:</b>  full body, front and back view, fashion pose, lineup, fashion illustration or technical drawing</li>
<li><b>Garment Specifications:</b></li>
<ul>
<li>Type: cargo pants, jumpsuit, blazer, workwear  </li>
...
{{< items title="Example Prompts and Images Generated" style="style2 small" >}}
{{< /items >}}
...
1. **Create project-specific boards** to keep your inspiration organized  
2. **Use multiple search terms** to cast a wide net for inspiration  
3. **Pin reference images** and **detail shots** to capture both overall concepts and specific construction techniques  
4. **Follow the algorithm's suggestions** \- Pinterest's related content feature often leads to unexpected inspiration

### **AI Prompting Best Practices:**

1. **Be extremely specific** about what you want to see  
2. **Include technical fashion terminology** to get more accurate results  
3. **Specify presentation style** (photorealistic, fashion pose, etc.)  
4. **Generate multiple variations** before moving to the next concept  
5. **Use generated images as starting points** for more refined prompts

### **Integration Workflow:**

1. **Start with Pinterest research** to understand existing visual language  
2. **Use AI to generate original concepts** based on your research insights  
3. **Return to Pinterest** to research specific details revealed in your AI images  
4. **Iterate between both platforms** to refine your vision
