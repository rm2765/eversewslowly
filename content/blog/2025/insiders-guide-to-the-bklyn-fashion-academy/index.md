...
When I applied, I searched everywhere for details on what the program is really like. I couldn't find anything beyond the [basic program description](https://www.bklynlibrary.org/bklyn-fashion-academy) and went through the experience with little to no advance preparation. 

This guide provides the comprehensive overview I wish I'd had.
This is the **first detailed insider's look** at the BKLYN Fashion Academy, written from a student's perspective. 
...
**👉 TL;DR:** Short on time? [Check out this quick overview](https://eversewslowly.com/blog/2025/nine-things-you-should-know-about-the-bklyn-fashion-academy/) for the essentials, or keep reading for the full breakdown. 

# What is the BKLYN Fashion Academy?

## 🧵 A Free Fashion Design Program in Brooklyn

The [**BKLYN Fashion Academy**](https://www.bklynlibrary.org/bklyn-fashion-academy) (BFA) is a free, 16-week fashion program run by the Brooklyn Public Library (BPL). Aspiring designers create mini-collections, develop business skills, and showcase their work in a professional runway show.

{{< figure src="central_library.jpg" alt="BKLYN Public Library - Central Branch" caption="BKLYN Public Central Library" class="image right small" >}} 

## 🪡 How It Started

BPL staff developed the academy through the library's BKLYN Incubator Project. Rather than starting from scratch, they drew upon on NYC's fashion legacy and existing partnerships. This created what may be the country's only [library-based fashion program](https://research.ebsco.com/c/tvrejk/search/details/mhdglekeyv?q=BKLYN%20fashion%20academy%3A%20a%20case%20study%20of%20a%20public%20library%20program%20supporting%20fashion%20entrepreneurs).

Key partners shaped the program's curriculum and industry connections, including Pratt’s Brooklyn Fashion \+ Design Accelerator, [Mood U](https://www.moodfashionstudio.com/), and [Materials for the Arts](https://www.nyc.gov/content/mfta/pages/). The program has had unique partners as well like [Microsoft Research](https://www.microsoft.com/en-us/research/blog/fashion-forward-researchers-designers-debut-new-tech-on-new-york-city-runway/), who collaborated with participants to integrate wearable technology into their designs.

[FABSCRAP](https://fabscrap.org/), [BK Style Foundation \- FWB](https://www.bkstyle.org/), and [Women.NYC](https://women.nyc/) are current collaborators that support the program's focus on sustainability and inclusion.
...
* **Mode en Couleur** (2018) 🎥 [Watch the show](https://www.facebook.com/BPLBusiness/videos/168464010507102/) <br>
Celebrating the vibrant Congolese *Les Sapeurs* movement  
   
* **Homage to Future Fashion** (2019) 🎥 [Microsoft Research](https://youtu.be/TvSmYga2Pic) | [Part 1](http://www.facebook.com/BPLBusiness/videos/574408576415063/) | [Part 2](https://www.facebook.com/BPLBusiness/videos/675986789521338/) <br>
Neo-Victorian steampunk honoring Namibia's Herero women, featuring Microsoft Research wearable technology  
 
* **2023: Ancient Egypt: Gods of the Runway** 🎥 [Watch the show](https://youtu.be/JqYUdEdz_pg?si=J7IBEoG_tCLzss-B)<br>
...
{{< figure src="tote.jpg" alt="Tote Bag with Sewing Supplies " caption="Tote Bag with Sewing Supplies" class="full" >}} 
...
The interview takes place at the Library’s [**Business & Career Center**](https://www.bklynlibrary.org/locations/central/business-career-center). The panel typically includes 4-5 industry professionals including educators, small business owners, and program alumni now working in the industry.
...
* A **resource lis**t (sewing books, [library links](https://bklynlibrary.libguides.com/fashion), and fabric/notion suppliers)
...
| :---- | :---- | :---- | :---- |
| <ul><li>Orientation & Professional Headshots</li> <li>Design Realization</li> <li>Sustainable Manufacturing</li></ul> | <ul><li>Patternmaking Lab </li> <li>Material Sourcing and Pickup </li> <li>Sample development & Sourcing </li> <li>Cut and Fit Lab | <ul><li>Cost Negotiations & Supply Chain </li> <li> Market Research </li> <li>Garment Construction Lab </li> <li>Sample Completion Lab</li></ul> |<ul><li> Final Sample Review  </li> <li>Mandatory Check-ins</li> <li> Runway show Prep day</li></ul> |
...
{{< figure src="main_look_rose.jpg" alt="Main Look on Canvas" caption="Main Look on Canvas" class="image right small" >}} 
...
My vision was greater representation of women in the emergency services industry. To bring it to life, I created an [**AI-assisted Pinterest moodboard**](https://eversewslowly.com/blog/2025/how-i-used-pinterest-and-ai-to-nail-my-design-vision/) featuring female firefighters and pioneers like Amelia Earhart. Those visuals made it much easier to pitch my ideas to my mentor.

Next came design worksheets—similar to [fashion briefs](https://www.pointsofmeasure.com/tutorials-education/design-brief)—to help shape our ideas. The best way to approach them is as brainstorming tools, not tests (though it’s hard to feel relaxed when you’re filling them out with CBS videographers filming).

From there, you **sketch six initial looks** and refine them into **four final designs** for your capsule collection.
{{< figure src="sketch_lineup.jpg" alt="Six Initial Looks" caption="Six Initial Looks" class="full" >}} 
...
Taught by [**Tara St James**](https://www.resourced.fashion/tarastjames) of Re:Source(d), this class offered a comprehensive framework for applying sustainable practices to fashion. It pushed us beyond aesthetics and trends into systems thinking and long-term impact.
...
* **The Design Phase Matters:** [Often cited by sustainability experts](https://www.ellenmacarthurfoundation.org/news/an-introduction-to-circular-design), up to 80% of a product’s environmental impact is determined during design, giving designers enormous responsibility for sustainable outcomes.
...
While *Designing for Sustainable Manufacturing* explored integrating sustainable practices throughout the fashion production pipeline, the two classes led by [**Roberto Silva**](https://www.luzstudiobrooklyn.com/) of Luz Studio focused on technical execution. Silva introduced the terminology and processes needed to turn a design into production.
...
{{< figure src="tech_sketch.jpg" alt="Technical Sketch" caption="Technical Sketch" class="full" >}} 
...
The final class was an introduction to [**Market Research for Fashion Businesses**](https://bklynlibrary.libguides.com/fashion). Market research means understanding your **customers, competitors, and industry trends** to guide smart business decisions. Before launching products or campaigns:
...
A BPL business librarian showed us how to use professional research platforms like [SimplyAnalytics](https://www.bklynlibrary.org/online-resources/simplyanalytics), [Statista](https://www.bklynlibrary.org/online-resources/statista), and [Mintel](https://www.bklynlibrary.org/online-resources/mintel-reports-academic)—all free with a library card. We learn how to find answers to key questions like: Is there demand for my product? Where are my customers? What should I charge?
...
The BFA partners with [FABSCRAP](https://shopfabscrap.org/?ref=eversewslowly), a nonprofit textile reuse center that diverts unused fabric from landfills to designers. Early in the program, we [volunteered at their warehouse](https://www.instagram.com/p/C84rXxeONvk/?igsh=MWticHM4YzJzMDJmcg%3D%3D)—earning **10 lbs of free fabric** and a **discount** for future purchases. Many of us left with bags of textiles, trims, and fresh inspiration while supporting a more sustainable fashion system.

**👉 Tip**: *Bring a reusable bag or backpack—you’ll need it to haul everything home.*

[FABSCRAP](https://shopfabscrap.org/?ref=eversewslowly) became the primary fabric source for participants, myself included. Thrift stores also proved invaluable for unique textiles, especially unexpected materials like vinyl or oversized garments perfect for deconstruction. Don't overlook fabric swapping with your cohort either.
...
{{< figure src="fabscrap_group.png" alt="FabScrap Outing" caption="FabScrap Outing" class="full" >}} 
...
**👉 Tip:** *Search for [free patterns online](https://www.reddit.com/r/freepatterns/comments/m8fllx/my_goto_free_pattern_sites/) and customize them—it saves time and gives you a solid starting point.*
...
{{< figure src="lab_prez.jpg" alt="Lab Session" caption="Lab Session" class="full" >}} 

---

# Working with Models
## The Professional Reality
{{< figure src="casting_nadia.png" alt="Casting at the BKLYN Public Library" caption="Casting at the BKLYN Public Library" class="image right small" >}} 
One of the most exciting parts of the program is seeing your designs on the runway, but first comes an important step: **casting models**. The program partners with [Fashion Week Brooklyn](https://www.bkstyle.org/fwbk) to provide authentic casting opportunities. Casting sessions take place at the library and partner venues, right when you're finishing your garments.
...
**✅ Licensed runway music is a must** – You can search libraries like [Epidemic Sound](https://share.epidemicsound.com/phstgx), or you can [commission a custom track](https://soundcloud.com/jeremy-kaplan-365985113/roses-runway-piano-version).
...
{{< figure src="made_it.webp" alt="Made it" caption="Made it to the Runway" class="full" >}} 
...
If you're interested in their stories and insights, read more here:*📎 [Behind the Seams reflection](https://eversewslowly.com/blog/2025/behind-the-seams/)*
